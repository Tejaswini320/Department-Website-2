      ...
      <AuthProvider>
        <DataProvider>
          ...
          <Routes>
            ...
            <Route path="/student-corner/projects" element={<PublicLayout><StudentProjects /></PublicLayout>} />
      ...
      <div className="grid md:grid-cols-3 gap-8">
        ...
        <div>
          ...
          <ul className="space-y-2 text-sm">
            ...
            <li><a href="/student-corner/projects" className="text-primary hover:underline">Student Projects</a></li>
          </ul>
        </div>
        <div>
